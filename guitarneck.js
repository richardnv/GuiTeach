...
//     console.log(`String index: ${i}, Tuning Value: ${this.working_tuning_array[i]}`);
...
//     let stringRootNote = parseInt(this.working_tuning_array[i]);   
...
// GuitarNeck.prototype.print_layout = function(curLayout) {
...
// GuitarNeck.prototype.setNeckLayout = function(layoutName) {
